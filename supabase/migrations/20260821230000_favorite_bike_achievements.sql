alter function public.refresh_profile_achievement_levels(uuid)
  rename to refresh_profile_levels_before_favorite_bike;
...
as $$
begin
  perform public.refresh_profile_levels_before_favorite_bike(p_user_id);
  perform public.refresh_profile_bike_achievement(p_user_id);
end;
$$;

revoke all on function public.refresh_profile_levels_before_favorite_bike(uuid)
  from public;
